...
const AddClient = (connexion, { name, surname, num, mail, handicap, civilite, birth, password, contact_mail, contact_num, note }, callback) => {
    const query = `
        INSERT INTO Client (name, surname, num, mail, handicap, civilite, birth, password, contact_mail, contact_num, note)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `;
    const values = [name, surname, num, mail, handicap, civilite, birth, password, contact_mail, contact_num, note];
